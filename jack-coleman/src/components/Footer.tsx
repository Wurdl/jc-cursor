    ...
    <footer className="bg-primary border-t border-white/10">
      ...
      <div className="container mx-auto py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="inline-block mb-6 text-white">
              <h2 className="text-2xl font-bold">Jack-Coleman</h2>
            </Link>
            <p className="text-white/60 mb-6 max-w-md">
              Wir sind Ihre Partner für digitale Exzellenz. Von Web-Entwicklung bis Marketing - wir gestalten Ihre digitale Zukunft.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/clients" className="text-white/60 hover:text-white transition-colors">
                  Kunden
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2 text-white/60">
                ...
                <a href="mailto:info@jack-coleman.de" className="text-white/60 hover:text-white transition-colors">
                  info@jack-coleman.de
                </a>
              </li>
              <li className="flex items-center space-x-2 text-white/60">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="tel:+49123456789" className=" text-white/60 hover:text-white transition-colors">
                  +49 123 456789
                </a>
              </li>
              <li className="flex items-center space-x-2 text-white/60">
                ...
                <span>Lendplatz 10, 8020 Graz</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-center text-white/40">
          <p>&copy; {currentYear} Jack-Coleman. Alle Rechte vorbehalten.</p>
        </div>
      </div>
    </footer>
  );
